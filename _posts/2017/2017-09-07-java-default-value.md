...
categories:
- JAVA
date: 2017-09-07 08:02:34
description: How is the default java heap size determined?
layout: post
tags:
- JAVA
title: How is the default java heap size determined?
...
-Xmx is in MaxHeapSize, 
-Xms is in InitialHeapSize. 
Filter your output (e.g. |grep on linux) or save it in a file so you can search in it.
...
ccstrlist CompileOnly                               =                                     {product}
   ...
   double G1ConcMarkStepDurationMillis              = 10.000000                           {product}
    ...
    uintx MaxNewSize                               := 87359488                            {product}
